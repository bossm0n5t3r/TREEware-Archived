...
ALTER TABLE EMP ADD (EMP_CRT VARCHAR2(300));
...
ALTER TABLE CMT ADD (WORK_OUT_TM date);
ALTER TABLE CMT ADD (GO_OUT_TM date);
ALTER TABLE CMT ADD (COME_BACK_TM date);
...
COMMENT ON COLUMN CMT.WORK_OUT_TM IS '외근';

COMMENT ON COLUMN CMT.GO_OUT_TM IS '외출';

COMMENT ON COLUMN CMT.COME_BACK_TM IS '복귀';
...
-- 관리자
INSERT INTO EMP (EMP_SQ,PMS_SQ,DPT_SQ,RNK_SQ,PST_SQ,EMP_NM,EMP_ID,EMP_PW,EMP_SEX,EMP_BDATE,EMP_ML_ID,EMP_ML_ADDR,EMP_TEL1,EMP_TEL2,EMP_TEL3,EMP_ZIP,EMP_ADDR,EMP_ADDR_DT,EMP_BS_TEL1,EMP_BS_TEL2,EMP_BS_TEL3,EMP_REG,EMP_MOD,EMP_FNL_MOD)
