										...
										<div class="row">
											<div class="col-md-3">
												<label class="form-check-label">
													...
													<span class="form-check-sign">사원번호<input type="text" readonly="readonly" value="TREE200966222"></span>
												</label>
												<img src="${root}/assets/img/profile1.jpg" width="100%" style="margin:5px 0px 10px 0px;padding:5px">
												<input type="file">
											</div>
											<div class="col-md-9">
												<div class="row">
													<div style="width:50%" class="box-group"><input type="text" name="name" id="name" class="mainbox" placeholder="사용할 아이디" readonly="readonly"></div>
													<div style="width:50%" class="box-group"><input type="password" name="name" id="name" class="mainbox" placeholder="비밀번호" readonly="readonly"></div>
														...
														<div class="row" style="margin:5px">
															<div style="width:50%" class="box-group">
																...
																<tr>
																	...
																	<td align="right">
																		<input name="department" id="department" data-toggle="modal" data-target="#departments" class="btn btn-primary btn-sm" type="button" value="찾아보기">
																	</td>
																</tr>
																</table>
															</div>
															...
															<div style="width:35%" class="box-group"><input type="text" name="name" id="name" class="mainbox" placeholder="이름" required></div>
															<div style="width:35%" class="box-group"><input type="text" name="name" id="name" class="mainbox" placeholder="생년월일 8자리" required></div>
															...
															<div style="width:50%" class="box-group"><input type="text" name="name" id="name" class="mainbox" placeholder="phone" required></div>
															<div style="width:25%" class="box-group"><input type="text" name="name" id="name" class="mainbox" placeholder="입사일" required></div>
															<div style="width:25%" class="box-group"><input type="text" name="name" id="name" class="mainbox" placeholder="퇴사일" required></div>
														</div>
													</div>
													<div style="width:50%" class="box-group">
														<table style="width:100%">
															<tr>
																<td><input type="text" name="name" id="name" class="mainbox" style="border:0" placeholder="우편번호를 검색하세요"></td>
																<td align="right">
																	<input name="address" id="address" data-toggle="modal" data-target="#zipcode" class="btn btn-default btn-sm" type="button" value="찾아보기">
																</td>
															</tr>
														</table>
													</div>
													<div style="width:50%" class="box-group"><input type="text" name="name" id="name" class="mainbox" placeholder="상세주소를 입력하세요"></div>
													<div style="width:50%" class="box-group"><input type="text" name="name" id="name" class="mainbox" placeholder="개인 이메일" required></div>
													<div style="width:50%" class="box-group"><input type="text" name="name" id="name" class="mainbox" placeholder="내선번호" required></div>
